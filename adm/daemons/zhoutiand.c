...
/*  冲穴效果代码列表
QI:N                   气血上限+N       /adm/daemons/race/human.c  jingmai/qi
NEI:N                  内力上限+N       /clone/user/user.c         jingmai/neili
ATK:N                  命中等级+N       combatd.c                  jingmai/attack
DMG:N                  伤害等级+N       power.c combatd.c          jingmai/damage
NEI:N                  防护等级+N       power.c combatd.c          jingmai/armor
...
POT:N                  体会上限+N       /clone/user/user.c         jingmai/mar
POT:N                  潜能上限+N       /clone/user/user.c         jingmai/pot
ATK:N               冥思效果+N%      /cmds/.../reflect.c        jingmai/reflect
FOOD:N                 食物上限+N       /feature/damage.c          jingmai/food
WATER:N                饮水上限+N       /feature/damage.c          jingmai/water
ATK:N               抗毒提升+N%      /feature/condition.c       jingmai/avoid_poison
...
mapping tongren_list = ([
        ...
        "tongren b4"    :  ({"阳跷脉","居髎穴", "QI:800:NEI:10","900"}),
        "tongren b5"    :  ({"阳跷脉","臑俞穴", "QI:500:POT:50","800"}),
        ...
        "tongren b16"   :  ({"阳跷脉","承光穴", "QI:800:NEI:20","2000"}),
        "tongren b17"   :  ({"阳跷脉","通天穴", "QI:1200","1000"}),
        "tongren b18"   :  ({"阳跷脉","络却穴", "QI:500:POT:100","1100"}),
        ...
        "tongren d3"    :  ({"阳维脉","肩井穴", "POT:200:POT:200","2000"}),
        ...
        "tongren d10"   :  ({"阳维脉","目窗穴", "POT:500:ATK:1","5500"}),
        "tongren d11"   :  ({"阳维脉","正营穴", "POT:500","600"}),
        "tongren d12"   :  ({"阳维脉","脑空穴", "POT:700:NEI:20","3500"}),
        ...
        "tongren d22"   :  ({"阳维脉","太渊穴", "POT:100:ATK:2","12000"}),
        ...
        "tongren f2"    :  ({"冲脉","阴交穴", "NEI:10","1000"}),
        "tongren f3"    :  ({"冲脉","气冲穴", "NEI:10","1000"}),
        "tongren f4"    :  ({"冲脉","横骨穴", "ATK:20","1000"}),
        "tongren f5"    :  ({"冲脉","大赫穴", "JIALI:50","1000"}),
        "tongren f6"    :  ({"冲脉","气穴", "JING:20","1000"}),
        "tongren f7"    :  ({"冲脉","四满穴", "JING:30","1000"}),
        "tongren f8"    :  ({"冲脉","中注穴", "NEI:20","2000"}),
        "tongren f9"    :  ({"冲脉","盲俞穴", "NEI:30","3000"}),
        "tongren f10"   :  ({"冲脉","商曲穴", "NEI:40","4000"}),
        ...
        "tongren f18"   :  ({"冲脉","大巨穴", "ATK:1","4000"}),
        "tongren f19"   :  ({"冲脉","天枢穴", "ATK:2","10000"}),
        "tongren f20"   :  ({"冲脉","气舍穴", "QI:20","1000"}),
        "tongren f21"   :  ({"冲脉","水突穴", "NEI:40","4000"}),
        ...
        "tongren h14"   :  ({"任外脉","箕门穴", "POT:20:_STR:1","6000"}),
        "tongren h15"   :  ({"任外脉","涌泉穴", "POT:20:_INT:1","9000"}),
        "tongren h16"   :  ({"任外脉","神封穴", "POT:20:_DEX:2","6000"}),
        "tongren h17"   :  ({"任外脉","地机穴", "POT:20:_DEX:3","6000"}),
        ...
        "tongren i17"   :  ({"经外奇脉","腰痛点穴", "POT:10","8000"}),
        "tongren i18"   :  ({"经外奇脉","鹤顶穴", "POT:20","8000"}),
        "tongren i19"   :  ({"经外奇脉","百虫窝穴", "POT:30","8000"}),
        "tongren i20"   :  ({"经外奇脉","膝眼穴", "POT:40","8000"}),
        "tongren i21"   :  ({"经外奇脉","胆囊穴", "DMG:10","30000"}),
        "tongren i22"   :  ({"经外奇脉","阑尾穴", "NEI:40","30000"}),
...
/////////////////////////////////////////////////////////////////////////
        ...
        "tongren k7"    :  ({"手太阳脉","天容穴", "NEI:30:NEI:10","300"}),
        ...
        "tongren l8"    :  ({"足太阴脉","大都穴", "NEI:30:POT:50","4000"}),
        ...
        "tongren l18"   :  ({"足太阴脉","胸乡穴", "NEI:30:NEI:10","800"}),
        ...
        "tongren m23"   :  ({"足太阳脉","大纾穴", "POT:30:NEI:10","600"}),
        ...
        "tongren o4"    :  ({"手少阳脉","耳门髎穴", "JING:20:NEI:10","1000"}),
        ...
        "tongren o10"   :  ({"手少阳脉","青冷渊穴", "NEI:30:POT:50","4000"}),
        ...
        "tongren p12"   :  ({"足少阴脉","腹通谷穴", "NEI:30:ATK:1","4000"}),
        ...
        // 手阳明脉
        "tongren r1"    :  ({"手阳明脉","肘髎穴", "QI:20:ADDPOT:10000","8000"}),
        "tongren r2"    :  ({"手阳明脉","手五里穴", "QI:30:ADDPOT:10000","8000"}),
        "tongren r3"    :  ({"手阳明脉","曲池穴", "QI:40:ADDPOT:10000","8000"}),
        "tongren r4"    :  ({"手阳明脉","迎香穴", "QI:20:ADDPOT:10000","30000"}),
        "tongren r5"    :  ({"手阳明脉","臂儒穴", "QI:30:ADDPOT:10000","8000"}),
        "tongren r6"    :  ({"手阳明脉","巨骨穴", "QI:40:ADDPOT:10000","8000"}),
        "tongren r7"    :  ({"手阳明脉","天鼎穴", "QI:50:ADDPOT:10000","8000"}),
        "tongren r8"    :  ({"手阳明脉","扶突穴", "QI:60:ADDPOT:10000","8000"}),
        "tongren r9"    :  ({"手阳明脉","口禾髎穴", "QI:30:ADDPOT:10000","8000"}),
        "tongren r10"   :  ({"手阳明脉","合谷穴", "QI:30:ADDPOT:10000","8000"}),
        "tongren r11"   :  ({"手阳明脉","二间穴", "QI:30:ADDPOT:10000","8000"}),
        "tongren r12"   :  ({"手阳明脉","三间穴", "FOOD:30:ADDPOT:10000","8000"}),
        "tongren r13"   :  ({"手阳明脉","商阳穴", "FOOD:20:ADDPOT:10000","8000"}),
        "tongren r14"   :  ({"手阳明脉","阳溪穴", "FOOD:30:ADDPOT:10000","8000"}),
        "tongren r15"   :  ({"手阳明脉","手三里穴", "FOOD:40:ADDPOT:10000","8000"}),
        "tongren r16"   :  ({"手阳明脉","上廉穴", "WATER:20:ADDPOT:10000","8000"}),
        "tongren r17"   :  ({"手阳明脉","下廉穴", "WATER:30:ADDPOT:10000","8000"}),
        "tongren r18"   :  ({"手阳明脉","温溜穴", "WATER:40:ADDPOT:10000","8000"}),
        "tongren r19"   :  ({"手阳明脉","偏历穴", "WATER:20:ADDPOT:10000","8000"}),

        // 足阳明脉
        "tongren s1"    :  ({"足阳明脉","承泣穴", "POT:20:FOOD:100","8000"}),
        "tongren s2"    :  ({"足阳明脉","四白穴", "POT:30:FOOD:100","8000"}),
        "tongren s3"    :  ({"足阳明脉","巨髎穴", "POT:40:FOOD:100","8000"}),
        "tongren s4"    :  ({"足阳明脉","地仓穴", "POT:20:FOOD:100","30000"}),
        "tongren s5"    :  ({"足阳明脉","下关穴", "POT:30:FOOD:100","8000"}),
        "tongren s6"    :  ({"足阳明脉","头维穴", "POT:40:FOOD:100","8000"}),
        "tongren s7"    :  ({"足阳明脉","人迎穴", "POT:50:FOOD:100","8000"}),
        "tongren s8"    :  ({"足阳明脉","水突穴", "POT:60:FOOD:100","8000"}),
        ...
        "tongren s28"   :  ({"足阳明脉","气冲穴", "JING:40:NEI:10","8000"}),
        ...
        "tongren s40"    :  ({"足阳明脉","历兑穴", "NEI:30:NEI:10","8000"}),
        ...
        "tongren t8"    :  ({"手厥阴脉","蹊门穴", "JING:50:POT:50","8000"}),
        "tongren t9"    :  ({"手厥阴脉","中冲穴", "JING:50:POT:50","8000"}),
...
void add_chongxue_effect(object me, string effect)
{
        ...
        me->add("experience", 10000);
        write(HIC "冲穴效果：" + effect_desc(effect) + "\n" NOR);
        write(HIY "冲穴奖励：二万点潜能及一万点实战体会。\n" NOR);
        ...
        for( i = 1; i <= n; i += 2 )
        {
                ...
                switch(tmp[i-1])
                {
                        case "QI":
                                ...
                                break;
                        case "NEI":
                                me->add("jingmai/neili", p);
                                break;
                        case "ATK":
                                me->add("jingmai/attack", p);
                                break;
                        case "DMG":
                                me->add("jingmai/damage", p);
                                break;
                        case "ARM":
                                me->add("jingmai/armor", p);
                                break;
                        case "JIALI":
                                me->add("jingmai/jiali", p);
                                break;
                        case "JING":
                                me->add("jingmai/jing", p);
                        case "POT":
                                me->add("jingmai/pot", p);
                                break;
                        case "POT":
                                me->add("jingmai/pot", p);
                                break;
                        case "ATK":
                                ...
                                break;
                        case "FOOD":
                                me->add("jingmai/food", p);
                                break;
                        case "WATER":
                                me->add("jingmai/water", p);
                                break;
                        case "ATK":
                                me->add("jingmai/avoid_poison", p);
                                break;
                        case "_STR":
                                me->add("jingmai/str", p);
                                break;
                        case "_DEX":
                                me->add("jingmai/dex", p);
                                break;
                        case "_INT":
                                me->add("jingmai/int", p);
                                break;
                        case "_CON":
                                me->add("jingmai/con", p);
                                break;
                        case "STR":
                                me->add("str", p);
                                break;
...
void add_jingmai_effect(object me, string jing)
{
        ...
        {
                case "阴跷脉":
                        me->add("jingmai/qi", 600);
                        me->add("jingmai/neili", 200);
                        me->add("jingmai/jingli", 200);
                        me->add("jingmai/pot", 400);
                        me->add("jingmai/damage", 20);
                        me->add("jingmai/kar", 1);

                       // MYGIFT_D->check_mygift(me, "newbie_mygift/yinqiaomai");
                        break;

                case "阳跷脉":
                        me->add("jingmai/qi", 20000);
                        me->add("jingmai/neili", 800);
                        me->add("jingmai/jingli", 600);
                        me->add("jingmai/pot", 1000);
                        me->add("jingmai/attack", 200);
                        me->add("jingmai/armor", 50);
                        me->add("jingmai/damage", 40);
                        me->add("jingmai/magic_find", 1);
                        break;

                case "阴维脉":
                        me->add("jingmai/qi", 1000);
                        me->add("jingmai/neili", 5000);
                        me->add("jingmai/pot", 1000);
                        me->add("jingmai/attack", 40);
                        me->add("jingmai/damage", 20);
                        break;

                case "阳维脉":
                        me->add("jingmai/qi", 500);
                        me->add("jingmai/neili", 500);
                        me->add("jingmai/jing", 4000);
                        me->add("jingmai/pot", 10000);
                        me->add("jingmai/research_times", 100);
                        me->add("jingmai/research_effect", 5);
                        me->add("jingmai/derive_effect", 10);
                        me->add("jingmai/reflect", 3);
                        break;

                case "带脉":
                        me->add("jingmai/qi", 500);
                        me->add("jingmai/neili", 500);
                        me->add("jingmai/jingli", 500);
                        me->add("jingmai/jiali", 400);
                        me->add("jingmai/damage", 100);
                        me->add("jingmai/armor", 120);
                        me->add("jingmai/attack", 120);
                        me->add("jingmai/magic_find", 1);
                        me->add("jingmai/kar", 1);
                        break;

                case "冲脉":
                        me->add("jingmai/qi", 4000);
                        me->add("jingmai/neili", 200);
                        me->add("jingmai/jingli", 600);
                        me->add("jingmai/damage", 20);
                        me->add("jingmai/armor", 200);
                        break;

                case "督外脉":
                        me->add("jingmai/qi", 300);
                        me->add("jingmai/neili", 200);
                        me->add("jingmai/damage", 300);
                        me->add("jingmai/attack", 300);
                        me->add("jingmai/jiali", 1000);
                        break;

                case "任外脉":
                        me->add("jingmai/qi", 200);
                        me->add("jingmai/neili", 100);
                        me->add("jingmai/jingli", 100);
                        me->add("jingmai/armor", 600);
                        me->add("jingmai/pot", 200);
                        me->add("jingmai/str", 60);
                        me->add("jingmai/dex", 60);
                        me->add("jingmai/con", 60);
                        me->add("jingmai/int", 60);
                        me->add("add_max_encumbrance", 100000);
                        break;

                case "经外奇脉":
                        me->add("jingmai/qi", 20000);
                        me->add("jingmai/neili", 10000);
                        me->add("jingmai/jingli", 5000);
                        me->add("jingmai/pot", 5000);
                        me->add("jingmai/damage", 100);
                        me->add("jingmai/armor", 100);
                        me->add("jingmai/attack", 100);
                        me->add("jingmai/magic_find", 2);
                        me->add("jingmai/kar", 2);
                        //me->add("str", 1);
                        //me->add("dex", 1);
                        //me->add("con", 1);
                        me->add("int", 1);
                ...
                case "手太阴脉":
                        me->add("jingmai/qi", 800);
                        me->add("jingmai/neili", 400);
                        me->add("jingmai/jingli", 400);
                        me->add("jingmai/pot", 10000);
                        me->add("jingmai/damage", 30);
                        me->add("jingmai/attack", 40);
                        me->add("jingmai/armor", 40);
                        break;

                case "手太阳脉":
                        me->add("jingmai/qi", 2000);
                        me->add("jingmai/neili", 1000);
                        me->add("jingmai/jingli", 1000);
                        me->add("jingmai/pot", 10000);
                        me->add("jingmai/magic_find", 2);
                        me->add("jingmai/damage", 50);
                        me->add("jingmai/str", 10);
                        me->add("jingmai/dex", 12);
                ...
                case "足太阴脉":
                        me->add("jingmai/qi", 2000);
                        me->add("jingmai/jingli", 1000);
                        me->add("jingmai/neili", 2000);
                        me->add("jingmai/pot", 30000);
                        me->add("jingmai/damage", 50);
                        me->add("jingmai/kar", 2);
                        me->add("jingmai/str", 10);
                        me->add("jingmai/con", 12);

                        break;

                case "足太阳脉":
                        me->add("jingmai/qi", 20000);
                        me->add("jingmai/jingli", 10000);
                        me->add("jingmai/neili", 10000);
                        me->add("jingmai/pot", 100000);
                        me->add("jingmai/kar", 4);
                        me->add("jingmai/magic_find", 4);
                        me->add("jingmai/damage", 400);
                        me->add("jingmai/attack", 200);
                        //me->add("int", 3);
                        //me->add("dex", 1);
                        me->add("str", 1);
                ...
                case "手少阴脉":
                        ...
                        me->add("jingmai/neili", 400);
                        me->add("jingmai/jingli", 400);
                        me->add("jingmai/pot", 2000);
                        me->add("jingmai/armor", 100);
                        me->add("jingmai/str", 6);
                        me->add("jingmai/int", 6);
                        me->add("jingmai/dex", 6);
                        me->add("jingmai/con", 6);
                ...
                case "手少阳脉":
                        ...
                        me->add("jingmai/jingli", 5000);
                        me->add("jingmai/pot", 5000);
                        me->add("jingmai/research_effect", 8);
                        break;

                case "足少阴脉":
                        me->add("jingmai/qi", 3000);
                        me->add("jingmai/neili", 3000);
                        me->add("jingmai/jingli", 2000);
                        me->add("jingmai/pot", 1000);
                        me->add("jingmai/derive_effect", 15);
                        me->add("jingmai/reflect", 5);
                        me->add("add_max_encumbrance", 200000);

                        break;

                case "足少阳脉":
                        me->add("jingmai/qi", 10000);
                        me->add("jingmai/neili", 5000);
                        me->add("jingmai/jingli", 4000);
                        me->add("jingmai/pot", 4000);
                        me->add("jingmai/jiali", 500);
                        me->add("jingmai/damage", 200);
                        me->add("jingmai/attack", 150);
                        me->add("jingmai/defense", 150);
                ...
                case "足厥阴脉":
                        ...
                        me->add("jingmai/jingli", 2000);
                        me->add("jingmai/pot", 2000);
                        me->add("jingmai/damage", 60);
                        me->add("jingmai/attack", 60);
                        me->add("jingmai/str", 20);
                        me->add("add_max_encumbrance", 100000);
                        break;
...
int check_zhoutian(object me, string jing)
{
        ...
        if( !me->query("x_zhoutian") )
        {
                for( i=0; i<sizeof(x_zhoutian); i++ )
                        if( !me->query("jingmai/"+x_zhoutian[i]+"/chongxue_ok") )
                        {
                                flag = 1;
                                break;
                        }
                ...
                if( !flag )
                {
                        ...
                        me->add("jingmai/research_effect", 30);
                        me->add("jingmai/derive_effect", 30);
                        me->add("jingmai/practice_effect", 30);
                        write(HIY "打通小周天奖励：一百万点潜能及一百万点修为。\n" NOR);
        ...
        flag = 0;
        if( !me->query("d_zhoutian") )
        {
                for( i=0; i<sizeof(d_zhoutian); i++ )
                        if( !me->query("jingmai/"+d_zhoutian[i]+"/chongxue_ok") )
                        {
                                flag = 1;
                                break;
                        }
                ...
                if( !flag )
                {
                        ...
                        me->add("potential", 1000000);
                        me->add("combat_exp", 1000000);
                        me->add("jingmai/research_effect", 50);
                        me->add("jingmai/derive_effect", 50);
                        me->add("jingmai/practice_effect", 50);
                        write(HIY "打通大周天奖励：一百万点潜能及一百万点修为。\n" NOR);
        ...
        if( me->query("breakup"))return 1;

        if( me->query("x_zhoutian") && me->query("d_zhoutian") )
        {
                me->set("breakup", 1);
                me->delete("jingmai");
                me->set("jingmai/finish", 1);
                write(HIR "恭喜你，打通了" + HIY + "全身大小周天经脉" + HIR "。\n" NOR);

                me->add("potential", 10000000);
                me->add("combat_exp", 10000000);
                /*
                me->add("jingmai/research_effect", 100);
                me->add("jingmai/derive_effect", 100);
                me->add("jingmai/practice_effect", 100);
                me->add("jingmai/reduce_damage", 10);
                */
                write(HIY "打通大小周天奖励：一千万点潜能及一千万点修为。\n" NOR);
...
int check_jingmai(object me, string jing)
{
        ...
        if( !me->query("jingmai/"+jing) )
                return 0;

        n=sizeof(keys(me->query("jingmai/"+jing)));
        ...
        me->set("jingmai/"+jing+"/chongxue_ok", 1);
...
int do_chongxue(object me, object tongren_ob)
{
        ...
        jing=tongren_ob->query("jingmai_name");
        xue=tongren_ob->query("xuewei_name");
        tongren_id=tongren_ob->query("id");

        if( me->query("jingmai/"+jing+"/"+tongren_id) )
                return notify_fail(xue + "已经被打通了。\n");

        if( me->query("neili")<tongren_ob->query("cost_neili") )
       ...
       // message_vision( HIC "突然$N" HIC "大喝一声，一股无形气浪陡然散布开来，四周空气登时变得燥热。\n" NOR);
        ...
        me->add("neili", -1*tongren_ob->query("cost_neili"));

        // 记录冲穴数据
        me->set("jingmai/"+jing+"/"+tongren_id, 1);
...
*/
        ...
        // 获取冲穴效果参数
        effect=tongren_ob->query("chongxue_xiaoguo");
...
void show_jingmai(object me, string jing)
{
        ...
        for( i = 0; i < sizeof(xuewei_names); i ++ )
        {
                ...
                if( me->query("jingmai/"+jing+"/"+xuewei_id) )
                        status = HIG "已打通" NOR;
                else
                        status = WHT "未打通" NOR;
