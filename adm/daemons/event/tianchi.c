...
private void do_bonus(object room)
{
	...
	if (r == 0)
	{
		...
		msg += HIC "你仔细的观察了流星雨的全过程，发现其中竟有很多奥秘可以融于武学。"NOR"\n";
		obs->add("potential", 30000);
		...
		foreach (ob in obs)
		{
			...
			{
				tell_object(ob, HIM "你心中一动，登时有所感悟，领悟了满天星中穹外飞星这一绝技！"NOR"\n");
	...
	if (r < 40)
	{
		...
		msg += HIC "你观罢流星，隐隐的对暗器功夫有了一丝体会。"NOR"\n";

		obs->improve_skill("throwing", 1000);
		message("vision", msg, obs);
	...
	} else
	{
		...
		{
		case 0:
			msg = WHT "眼见天边一片明亮，知是流星雨将至，可怎奈间隔遥且云层厚，却无缘得见。"NOR"\n";
			break;
		default:
			msg = WHT "眼见天边一片明亮，但是水气，雾气和云层交杂，让你什么都看不清楚。"NOR"\n";
			break;
		}
		msg += HIG "你心中连叹：“太可惜了！”"NOR"\n";
