...
private void do_bonus(object room)
{
	...
	{ 
		msg = HIR "只听轰隆隆声音大做，发耳欲聩，令人心神俱摇！你抬头看去，只见\n"
			  "晨曦中黄果树瀑布笼罩着层层雾气，分外要人。水流飞泻，气势惊人！"NOR"\n";
		msg += HIG "你望着湍急的瀑布飞练，为这世间美景惊叹不已，从"
			   "中不禁领悟到了武学的道理。"NOR"\n"; 
		obs->add("combat_exp", 50000);
		obs->add("potential", 50000);
	...
	if (r < 250) 
	{
		msg = HIY "一阵轰隆轰隆的声音传来，你抬头一看，只见晨曦中瀑布腾起层层雾气。"NOR"\n";
		switch (random(3)) 
		{ 
		case 0: 
			...
			break; 
		case 1: 
			msg += HIY "瀑流就像一席倒挂的白帘，气势如虹，天地都不禁为之失色。"NOR"\n"; 
			break; 
		default: 

			msg += HIY "瀑流直如水银泄地一般，水花四溅。"NOR"\n"; 
			break; 
		} 
		msg += HIG "观赏着飞流直下的水瀑，你不由得感叹自然造化的奇妙，隐"
			   "隐然对武学也有了一点领会。"NOR"\n"; 
		obs->improve_potential(500 + random(3000));
		obs->add("combat_exp", 200 + random(1000));
	...
	} else
	{
		...
		{
		case 0:
			msg = WHT "瀑流渐渐缓了下来。"NOR"\n";
			break;
		case 1:
			msg = WHT "瀑流总是不见有增强的趋势。"NOR"\n";
			break;
		default:
			msg = WHT "瀑流有如小桥流水，叮叮咚咚，离你所期望的相差甚远。"NOR"\n";
			break;
		}
		msg += HIG "你心中大感失望。"NOR"\n";
