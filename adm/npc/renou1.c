...
void create()
{
    ...
    set_skill("force", 600+random(600));
    set_skill("unarmed", 600+random(600));
    set_skill("dodge", 600+random(600));
    set_skill("parry", 600+random(600));
    set_skill("sword", 600+random(600));
    set_skill("hand", 600+random(600));
    set_skill("cuff", 600+random(600));
    set_skill("strike", 600+random(600));
    set_skill("finger", 600+random(600));
    set_skill("claw", 600+random(600));
    set_skill("blade", 600+random(600));
    set_skill("staff", 600+random(600));
    set_skill("hammer", 600+random(600));
    set_skill("club", 600+random(600));
    set_skill("whip", 600+random(600));
    
    set_skill("never-defeated", 600+random(600));
    set_skill("never-defeated", 600+random(600));
    set_skill("never-defeated", 600+random(600));
    set_skill("never-defeated", 600+random(600));
    set_skill("never-defeated", 600+random(600));
