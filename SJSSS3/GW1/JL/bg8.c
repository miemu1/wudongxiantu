...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【金丹限定】"NOR"金丹系列								
"HIG"《套装加成：修仙真法等级+200，攻击力30000》"NOR"\n");
	set("value",1000);
	set("armor_prop/armor", 3000);
	set("armor_prop/unarmed_damage", 3000+lv1+lv2+lv3);
	set("armor_prop/damage", 3000+lv1+lv2+lv3);	
	set("no_get",1);
	set("no_drop",1);
	set("no_put",1);
	...
	set("armor_type","pants");
		set("material", "fur");
				 set("suit",HIR"金丹套装"NOR);  //套装名称
		set("suit_lvl",6);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","金丹·护甲");
		set("suit_mod/finger","金丹·戒指");
		set("suit_mod/head","金丹·头饰");
		set("suit_mod/neck","金丹·项链");
		set("suit_mod/pants","金丹·护腿");
		set("suit_mod/boots","金丹·护靴");
		set("suit_mod/cloth","金丹·衣服");
		set("suit_mod/waist","金丹·腰带");
		set("suit_mod/wrists","金丹·护腕");
		...
		set("suit_eff/strength",30);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/xiuxian-gongfa",200+me->query("taozhuang/lv"));
	setup();
}
