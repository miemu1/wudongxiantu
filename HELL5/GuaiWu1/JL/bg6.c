...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【獠牙限定】"NOR"獠牙系列								
"HIG"《套装加成：基础棍法等级+35，攻击力350》"NOR"\n");
	set("value",1000);
	set("armor_prop/armor", 35);
	set("armor_prop/unarmed_damage", 35+lv1+lv2+lv3);
	set("armor_prop/damage", 35+lv1+lv2+lv3);	
	set("no_get",1);
	set("no_drop",1);
	set("no_put",1);
	...
	set("armor_type","head");
		set("material", "fur");
				 set("suit",HIR"獠牙套装"NOR);  //套装名称
		set("suit_lvl",3);	     //套装等级
		set("suit",HIR"獠牙套装"NOR);  //套装名称
		set("suit_lvl",3);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","獠牙·护甲");
		set("suit_mod/finger","獠牙·戒指");
//		set("suit_mod/hands","獠牙·手套");
		set("suit_mod/head","獠牙·头饰");
		set("suit_mod/neck","獠牙·项链");
		set("suit_mod/pants","獠牙·护腿");
		set("suit_mod/boots","獠牙·护靴");
		set("suit_mod/cloth","獠牙·衣服");
//		set("suit_mod/surcoat","獠牙·披风");
//		set("suit_mod/shield","獠牙·护盾");
		set("suit_mod/waist","獠牙·腰带");
		set("suit_mod/wrists","獠牙·护腕");
	    //套装全部附加天赋效果  //身法第一，根骨第二，悟性第三，臂力第四
		set("suit_eff/constitution",1);      //3件
		set("suit_eff/spirituality",1);      // 5件
		set("suit_eff/intelligence",1);      //7件
		set("suit_eff/strength",1);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/club",35+me->query("taozhuang/lv"));
	setup();
}
