...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【火麟限定】"NOR"火麟系列								
"HIG"《套装加成：开天仙经等级+75，攻击力750》"NOR"\n");
	set("value",1000);
	...
	set("armor_type","finger");
		set("material", "fur");
				 set("suit",HIR"火麟套装"NOR);  //套装名称
		set("suit_lvl",7);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","火麟·护甲");
		set("suit_mod/finger","火麟·戒指");
//		set("suit_mod/hands","火麟·手套");
		set("suit_mod/head","火麟·头饰");
		set("suit_mod/neck","火麟·项链");
		set("suit_mod/pants","火麟·护腿");
		set("suit_mod/boots","火麟·护靴");
		set("suit_mod/cloth","火麟·衣服");
//		set("suit_mod/surcoat","火麟·披风");
//		set("suit_mod/shield","火麟·护盾");
		set("suit_mod/waist","火麟·腰带");
		set("suit_mod/wrists","火麟·护腕");
