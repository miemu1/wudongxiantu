...
void create()
{
	set_name(HIC"嗜血狼妖"NOR, ({"yelang jing"}));
	set("nickname", "中级怪");
	set("gender", "无性");
	set("age", 9999);
	set("nolook", 1);
    ...
    setup();
    carry_object("/HELL5/GuaiWu2/Gzb/wuqi")->wield();
...
//	CHANNEL_D->do_channel(this_object(), "chat", HIR"唉，老身去也！"NOR"");
		...
		me->add("yuanbao",25);
        obj1 = new("/HELL5/BOX/box2");
        obj1->move(env);
		tell_object(me,sprintf(GRN"你获得了%d点修为，%d点潜能，%d点元神修为，25枚灵石，1个狼牙宝箱，请及时拾取，以免丢失\n"NOR,exp,pot,50000));
