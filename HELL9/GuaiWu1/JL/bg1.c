...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【天照限定】"NOR"天照系列								
"HIG"《套装加成：基础刀法等级+75，攻击力750》"NOR"\n");
	set("value",1000);
	...
	set("armor_type","armor");
		set("material", "armor");
				 set("suit",HIR"天照套装"NOR);  //套装名称
		set("suit_lvl",3);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","天照·护甲");
		set("suit_mod/finger","天照·戒指");
//		set("suit_mod/hands","天照·手套");
		set("suit_mod/head","天照·头饰");
		set("suit_mod/neck","天照·项链");
		set("suit_mod/pants","天照·护腿");
		set("suit_mod/boots","天照·护靴");
		set("suit_mod/cloth","天照·衣服");
//		set("suit_mod/surcoat","天照·披风");
//		set("suit_mod/shield","天照·护盾");
		set("suit_mod/waist","天照·腰带");
		set("suit_mod/wrists","天照·护腕");
		...
		set("suit_eff/strength",1);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/blade",75+me->query("taozhuang/lv"));
	setup();
}
