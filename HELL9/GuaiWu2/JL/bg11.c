...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【月读限定】"NOR"月读系列								
"HIG"《套装加成：基础刀法等级+95，攻击力950》"NOR"\n");
	set("value",1000);
	set("armor_prop/armor", 95);
	set("armor_prop/unarmed_damage", 95+lv1+lv2+lv3);
	set("armor_prop/damage", 95+lv1+lv2+lv3);	
	set("no_get",1);
	set("no_drop",1);
	set("no_put",1);
	...
	set("armor_type","waist");
		set("material", "fur");
				 set("suit",HIR"月读套装"NOR);  //套装名称
		set("suit_lvl",4);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","月读·护甲");
		set("suit_mod/finger","月读·戒指");
//		set("suit_mod/hands","月读·手套");
		set("suit_mod/head","月读·头饰");
		set("suit_mod/neck","月读·项链");
		set("suit_mod/pants","月读·护腿");
		set("suit_mod/boots","月读·护靴");
		set("suit_mod/cloth","月读·衣服");
//		set("suit_mod/surcoat","月读·披风");
//		set("suit_mod/shield","月读·护盾");
		set("suit_mod/waist","月读·腰带");
		set("suit_mod/wrists","月读·护腕");
		...
		set("suit_eff/strength",2);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/blade",95+me->query("taozhuang/lv"));
	setup();
}
