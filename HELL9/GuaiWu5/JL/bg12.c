...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【天之御中限定】"NOR"天之御中系列								
"HIG"《套装加成：基础刀法等级+150，攻击力1500》"NOR"\n");
	set("value",1000);
	...
	set("armor_type","wrists");
		set("material", "fur");
				 set("suit",HIR"天之御中套装"NOR);  //套装名称
		set("suit_lvl",7);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","天之御中·护甲");
		set("suit_mod/finger","天之御中·戒指");
//		set("suit_mod/hands","天之御中·手套");
		set("suit_mod/head","天之御中·头饰");
		set("suit_mod/neck","天之御中·项链");
		set("suit_mod/pants","天之御中·护腿");
		set("suit_mod/boots","天之御中·护靴");
		set("suit_mod/cloth","天之御中·衣服");
//		set("suit_mod/surcoat","天之御中·披风");
//		set("suit_mod/shield","天之御中·护盾");
		set("suit_mod/waist","天之御中·腰带");
		set("suit_mod/wrists","天之御中·护腕");
		...
		set("suit_eff/strength",10);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/blade",300+me->query("taozhuang/lv"));
	setup();
}
