...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【筑基限定】"NOR"筑基系列								
"HIG"《套装加成：修仙真法等级+150，攻击力20000》"NOR"\n");
	set("value",1000);
	set("armor_prop/armor", 2000);
	set("armor_prop/unarmed_damage", 2000+lv1+lv2+lv3);
	set("armor_prop/damage", 2000+lv1+lv2+lv3);	
	...
	set("armor_type","armor");
		set("material", "armor");
				 set("suit",HIR"筑基套装"NOR);  //套装名称
		set("suit_lvl",6);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","筑基·护甲");
		set("suit_mod/finger","筑基·戒指");
		set("suit_mod/head","筑基·头饰");
		set("suit_mod/neck","筑基·项链");
		set("suit_mod/pants","筑基·护腿");
		set("suit_mod/boots","筑基·护靴");
		set("suit_mod/cloth","筑基·衣服");
		set("suit_mod/waist","筑基·腰带");
		set("suit_mod/wrists","筑基·护腕");
		...
		set("suit_eff/strength",20);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/xiuxian-gongfa",150+me->query("taozhuang/lv"));
	setup();
}
