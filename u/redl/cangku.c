...
void do_start_hslj(string arg)
{
        ...
        if (!arg) {
                switch(random(4)) {
                        case 0:
                                message_system(NOR + HIW + "每月６、２１日，晚２０点华山绝顶开放[１号比武场]，限制２０级到１００级之间，奖品有勋章和武动仙途币，参与即有好礼。\n"NOR);
                                break;
                        case 1:
                                message_system(NOR + HIW + "每月６、２１日，晚２２点华山绝顶开放[２号比武场]，限制１０１级到２００级之间，奖品有勋章和武动仙途币，参与即有好礼。\n"NOR);
                                break;
                        case 2:
                                message_system(NOR + HIW + "每月７日，晚２０点华山绝顶开放[３号比武场]，限制２０１级之上，奖品有勋章和武动仙途币，参与即有好礼。\n"NOR);
                                break;
                        case 3:
                                message_system(NOR + HIW + "每月７日，晚２２点华山绝顶开放[华山论剑比武场]，不限武器装备，奖品有勋章和武动仙途币，参与即有好礼。\n"NOR);
                                break;
                }
                return;
        }
