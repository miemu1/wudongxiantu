...
int do_du(string arg)
{
        ...
        if (! me->query("family/family_name") || me->query("family/family_name") != "日月神教") 
        {
...
//        if ((int)me->query("combat_exp") < 300000)
        ...
        if (pfm == "po")
	{
       ...
       if (pfm == "wu") 
       {
               if ((int)me->query("can_perform/pixie-jian/wu")) 
               { 
                       write("你已经学会了这招，再研究也没用。\n"); 
                       return 1; 
               } 
              ...
              {  
                      ...
                      if (me->can_improve_skill("pixie-jian")) 
                              me->improve_skill("pixie-jian", 1500000); 
                      me->improve_skill("martial-cognize", 1500000); 
                      me->set("can_perform/pixie-jian/wu", 1); 
              } 
              me->receive_damage("jing", 80); 
              me->add("learned_points", 10); 
              me->start_busy(2); 
       ...
       if (pfm == "you") 
       {
               if ((int)me->query("can_perform/pixie-jian/you")) 
               { 
                       write("你已经学会了这招，再研究也没用。\n"); 
                       return 1; 
               } 
              ...
              {  
                      ...
                      if (me->can_improve_skill("pixie-jian")) 
                              me->improve_skill("pixie-jian", 1500000); 
                      me->improve_skill("martial-cognize", 1500000); 
                      me->set("can_perform/pixie-jian/you", 1); 
              } 
              me->receive_damage("jing", 80); 
              me->add("learned_points", 10); 
              me->start_busy(2); 
