...
//读入数据
	...
	lv1=me->query("jinjie/s1")*200;
	lv2=me->query("guizhen")*1000+me->query("zhengdao/s1")*100000+me->query("feisheng/s1")*20000000;
...
"HIG"《套装加成：基础技能等级+200，攻击力2000》"NOR"\n");
	...
	set("armor_type","pants");
		set("material", "fur");
				 set("suit",HIR"玄冥"NOR);  //套装名称
		set("suit_lvl",8);	     //套装等级
		set("suit_count",8);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","玄冥甲");
		set("suit_mod/finger","玄冥戒");
//		set("suit_mod/hands","玄冥手");
		set("suit_mod/head","玄冥盔");
		set("suit_mod/neck","玄冥链");
		set("suit_mod/pants","玄冥腿");
		set("suit_mod/boots","玄冥靴");
		set("suit_mod/cloth","玄冥衣");
//		set("suit_mod/surcoat","玄冥披");
//		set("suit_mod/shield","玄冥盾");
		set("suit_mod/waist","玄冥腰");
		set("suit_mod/wrists","玄冥腕");
