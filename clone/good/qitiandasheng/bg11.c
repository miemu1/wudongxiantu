...
"HIG"《套装加成：基础技能等级+200，攻击力2000》"NOR"\n");
	...
	set("armor_type","waist");
		set("material", "fur");
				 set("suit",HIR"齐天"NOR);  //套装名称
		set("suit_lvl",8);	     //套装等级
		set("suit_count",8);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","齐天甲");
		set("suit_mod/finger","齐天戒");
//		set("suit_mod/hands","齐天手");
		set("suit_mod/head","齐天盔");
		set("suit_mod/neck","齐天链");
		set("suit_mod/pants","齐天腿");
		set("suit_mod/boots","齐天靴");
		set("suit_mod/cloth","齐天衣");
//		set("suit_mod/surcoat","齐天披");
//		set("suit_mod/shield","齐天盾");
		set("suit_mod/waist","齐天腰");
		set("suit_mod/wrists","齐天腕");
