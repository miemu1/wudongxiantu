...
int do_effect(object me)
{
	...
	message_vision(HIM"$N轻轻打开了["+this_object()->query("name")+HIM+"]的盖子,宝箱化为一道紫色光华！"NOR"\n",me);
	...
	if (random(100)<100) {
		num=1+random(150);
		me->add("yuanbao",num);
		tell_object(me,""HIR"恭喜: "NOR"你从["+this_object()->query("name")+"]中得到了..."+chinese_number(num)+"个<< "HIY"灵石"NOR" >>"+NOR+"\n");
	} else {
