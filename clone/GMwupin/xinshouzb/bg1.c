...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【老魔限定】"NOR"老魔系列								
"HIG"《套装加成：草稚剑和笑傲八风等级+100，攻击力250》"NOR"\n");
	set("value",1000);
	...
	set("armor_type","armor");
		set("material", "armor");
				 set("suit",HIR"老魔套装"NOR);  //套装名称
		set("suit_lvl",1);	     //套装等级
		set("suit_count",5);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","老魔·护甲");
		set("suit_mod/finger","老魔·戒指");
		set("suit_mod/head","老魔·头饰");
		set("suit_mod/neck","老魔·项链");
		set("suit_mod/pants","老魔·护腿");
		set("suit_mod/boots","老魔·护靴");
		set("suit_mod/cloth","老魔·衣服");
		set("suit_mod/waist","老魔·腰带");
		set("suit_mod/wrists","老魔·护腕");
		...
		set("suit_eff/strength",1);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/youzhi-jian",100+me->query("taozhuang/lv"));
        set("suit_eff_skill/xiaoao-quan",100+me->query("taozhuang/lv"));
	setup();
}
