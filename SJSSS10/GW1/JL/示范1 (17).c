// ITEM Made by player(·ç·ç:fengfeng) /data/item/f/fengfeng-heada.c
...
void create()
{
	set_name("[1;36m[42m¶êÃ¼¹Ú[2;37;0m", ({ "heada" }));
	set_weight(750);
	set("item_make", 1);
	set("unit", "¶¥");
	set("long", "ÕâÊÇÓÉ[1;35mÎÞÃûÖ®Îï[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»¶¥Í·¿ø¡£
");
	set("makeinfo", "[1;31m
