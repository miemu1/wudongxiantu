...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【帝魂限定】"NOR"帝魂系列								
"HIG"《套装加成：太衍帝经等级+500》"NOR"\n");
	set("value",1000);
	set("armor_prop/armor", 2500);
	set("armor_prop/unarmed_damage", 2500+lv1+lv2+lv3);
	set("armor_prop/damage", 2500+lv1+lv2+lv3);	
	set("no_get",1);
	set("no_drop",1);
	set("no_put",1);
	...
	set("armor_type","cloth");
		set("material", "fur");
				 set("suit",HIR"帝魂套装"NOR);  //套装名称
		set("suit_lvl",9);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","帝魂·护甲");
		set("suit_mod/finger","帝魂·戒指");
//		set("suit_mod/hands","帝魂·手套");
		set("suit_mod/head","帝魂·头饰");
		set("suit_mod/neck","帝魂·项链");
		set("suit_mod/pants","帝魂·护腿");
		set("suit_mod/boots","帝魂·护靴");
		set("suit_mod/cloth","帝魂·衣服");
//		set("suit_mod/surcoat","帝魂·披风");
//		set("suit_mod/shield","帝魂·护盾");
		set("suit_mod/waist","帝魂·腰带");
		set("suit_mod/wrists","帝魂·护腕");
		...
		set("suit_eff/strength",25);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/taiyan-dijing",600+me->query("taozhuang/lv"));
	setup();
}
