...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【元婴限定】"NOR"元婴系列								
"HIG"《套装加成：修仙真法等级+250，攻击力40000》"NOR"\n");
	set("value",1000);
	...
	set("armor_type","boots");
				 set("suit",HIR"元婴套装"NOR);  //套装名称
		set("suit_lvl",6);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","元婴·护甲");
		set("suit_mod/finger","元婴·戒指");
		set("suit_mod/head","元婴·头饰");
		set("suit_mod/neck","元婴·项链");
		set("suit_mod/pants","元婴·护腿");
		set("suit_mod/boots","元婴·护靴");
		set("suit_mod/cloth","元婴·衣服");
		set("suit_mod/waist","元婴·腰带");
		set("suit_mod/wrists","元婴·护腕");
		...
		set("suit_eff/strength",random(20)+40);      //9件
	       //套装全部附加技能效果，一整套
		set("suit_eff/constitution",40);      //3件
		set("suit_eff/spirituality",40);      // 5件
		set("suit_eff/intelligence",40);      //7件
		set("suit_eff/strength",40);      //9件
	       //套装全部附加技能效果，一整套
