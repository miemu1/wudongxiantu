...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【剑徒限定】"NOR"剑徒系列								
"HIG"《套装加成：无上剑经等级+60，攻击力600》"NOR"\n");
	set("value",1000);
	set("armor_prop/armor", 60);
	set("armor_prop/unarmed_damage", 60+lv1+lv2+lv3);
	set("armor_prop/damage", 60+lv1+lv2+lv3);	
	set("no_get",1);
	set("no_drop",1);
	set("no_put",1);
	...
	set("armor_type","finger");
		set("material", "fur");
				 set("suit",HIR"剑徒套装"NOR);  //套装名称
		set("suit_lvl",4);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","剑徒·护甲");
		set("suit_mod/finger","剑徒·戒指");
//		set("suit_mod/hands","剑徒·手套");
		set("suit_mod/head","剑徒·头饰");
		set("suit_mod/neck","剑徒·项链");
		set("suit_mod/pants","剑徒·护腿");
		set("suit_mod/boots","剑徒·护靴");
		set("suit_mod/cloth","剑徒·衣服");
//		set("suit_mod/surcoat","剑徒·披风");
//		set("suit_mod/shield","剑徒·护盾");
		set("suit_mod/waist","剑徒·腰带");
		set("suit_mod/wrists","剑徒·护腕");
		...
		set("suit_eff/strength",10);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/wushang-jianjing",60+me->query("taozhuang/lv"));
	setup();
}
