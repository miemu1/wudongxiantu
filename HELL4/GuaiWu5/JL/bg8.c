...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【剑灵限定】"NOR"剑灵系列								
"HIG"《套装加成：无上剑经等级+500》"NOR"\n");
	set("value",1000);
	set("armor_prop/unarmed_damage", 500+lv1+lv2+lv3);
	set("armor_prop/damage", 750+lv1+lv2+lv3);	
	set("no_get",1);
	set("no_drop",1);
	set("no_put",1);
	...
	set("armor_type","pants");
		set("material", "fur");
				 set("suit",HIR"剑灵套装"NOR);  //套装名称
		set("suit_lvl",9);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","剑灵·护甲");
		set("suit_mod/finger","剑灵·戒指");
//		set("suit_mod/hands","剑灵·手套");
		set("suit_mod/head","剑灵·头饰");
		set("suit_mod/neck","剑灵·项链");
		set("suit_mod/pants","剑灵·护腿");
		set("suit_mod/boots","剑灵·护靴");
		set("suit_mod/cloth","剑灵·衣服");
//		set("suit_mod/surcoat","剑灵·披风");
//		set("suit_mod/shield","剑灵·护盾");
		set("suit_mod/waist","剑灵·腰带");
		set("suit_mod/wrists","剑灵·护腕");
	    //套装全部附加天赋效果  //身法第一，根骨第二，悟性第三，臂力第四
		set("suit_eff/constitution",25);      //3件
		set("suit_eff/spirituality",25);      // 5件
		set("suit_eff/intelligence",25);      //7件
		set("suit_eff/strength",25);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/wushang-jianjing",500+me->query("taozhuang/lv"));
	setup();
}
