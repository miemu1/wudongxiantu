...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【剑奴限定】"NOR"剑奴系列								
"HIG"《套装加成：无上剑经等级+100，攻击力500》"NOR"\n");
	set("value",1000);
	...
	set("armor_type","head");
		set("material", "fur");
				 set("suit",HIR"剑奴套装"NOR);  //套装名称
		set("suit_lvl",3);	     //套装等级
		set("suit",HIR"剑奴套装"NOR);  //套装名称
		set("suit_lvl",3);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","剑奴·护甲");
		set("suit_mod/finger","剑奴·戒指");
//		set("suit_mod/hands","剑奴·手套");
		set("suit_mod/head","剑奴·头饰");
		set("suit_mod/neck","剑奴·项链");
		set("suit_mod/pants","剑奴·护腿");
		set("suit_mod/boots","剑奴·护靴");
		set("suit_mod/cloth","剑奴·衣服");
//		set("suit_mod/surcoat","剑奴·披风");
//		set("suit_mod/shield","剑奴·护盾");
		set("suit_mod/waist","剑奴·腰带");
		set("suit_mod/wrists","剑奴·护腕");
		...
		set("suit_eff/strength",5);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/wushang-jianjing",100+me->query("taozhuang/lv"));
	setup();
}
