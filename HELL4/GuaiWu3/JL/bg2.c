...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【剑修限定】"NOR"剑修系列								
"HIG"《套装加成：无上剑经等级+300，攻击力700》"NOR"\n");
	set("value",1000);
	set("armor_prop/armor", 70);
	set("armor_prop/unarmed_damage", 70+lv1+lv2+lv3);
	set("armor_prop/damage", 70+lv1+lv2+lv3);	
	set("no_get",1);
	set("no_drop",1);
	set("no_put",1);
	...
	set("armor_type","boots");
				 set("suit",HIR"剑修套装"NOR);  //套装名称
		set("suit_lvl",5);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","剑修·护甲");
		set("suit_mod/finger","剑修·戒指");
//		set("suit_mod/hands","剑修·手套");
		set("suit_mod/head","剑修·头饰");
		set("suit_mod/neck","剑修·项链");
		set("suit_mod/pants","剑修·护腿");
		set("suit_mod/boots","剑修·护靴");
		set("suit_mod/cloth","剑修·衣服");
//		set("suit_mod/surcoat","剑修·披风");
//		set("suit_mod/shield","剑修·护盾");
		set("suit_mod/waist","剑修·腰带");
		set("suit_mod/wrists","剑修·护腕");
		...
		set("suit_eff/strength",15);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/cwushang-jianjing",300+me->query("taozhuang/lv"));
	setup();
}
