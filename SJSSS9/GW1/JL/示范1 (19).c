// ITEM Made by player(·ç·ç:fengfeng) /data/item/f/fengfeng-waista.c
...
void create()
{
	set_name("[1;36m[42m´ºË®ñÆ[2;37;0m", ({ "waista" }));
	set_weight(800);
	set("item_make", 1);
	set("unit", "Ìõ");
	set("long", "ÕâÊÇÓÉ[1;35mÎÞÃûÖ®Îï[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»ÌõÑü´ø¡£
");
	set("makeinfo", "[1;31m
