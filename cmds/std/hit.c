...
int main(object *obs,object me, string arg)
{
	...
	//if (me->query("quest/id") != obj->query("id"))			
		//return notify_fail("看清楚一点，那并不是你能招呼的对象。\n");	
	...
	if ((me->query("age")<10 || me->query("combat_exp",1)<200000) && userp(obj))
		return notify_fail("小小年纪就想杀人放火？还是练功去吧。\n");

	if ((obj->query("age")<10 || obj->query("combat_exp",1)<20) && userp(obj))
