// ITEM Made by player(·ç·ç:fengfeng) /data/item/f/fengfeng-clotha.c
...
void create()
{
	set_name("[1;36m[43m½ðÂÆÒÂ[2;37;0m", ({ "clotha" }));
	set_weight(2000);
	set("item_make", 1);
	set("unit", "¼þ");
	set("long", "ÕâÊÇÓÉ[1;35mÎÞÃûÖ®Îï[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»¼þÕ½ÒÂ¡£
");
	set("makeinfo", "[1;31m
