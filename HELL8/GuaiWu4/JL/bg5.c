...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【四圣限定】"NOR"玄武系列								
"HIG"《套装加成：炼狱魔经等级+150，攻击力500》"NOR"\n");
	set("value",1000);
	...
	if( me->query("jia/unequip_msg"))
		...
		set("material", "fur");
		set("suit",HIR"玄武套装"NOR);  //套装名称
		set("suit_lvl",7);	     //套装等级
		set("suit_count",12);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","玄武·护甲");
		set("suit_mod/finger","玄武·戒指");
		set("suit_mod/hands","玄武·手套");
		set("suit_mod/head","玄武·头饰");
		set("suit_mod/neck","玄武·项链");
		set("suit_mod/pants","玄武·护腿");
		set("suit_mod/boots","玄武·护靴");
		set("suit_mod/cloth","玄武·衣服");
		set("suit_mod/surcoat","玄武·披风");
		set("suit_mod/shield","玄武·护盾");
		set("suit_mod/waist","玄武·腰带");
		set("suit_mod/wrists","玄武·护腕");
		...
		set("suit_eff/strength",4);      //9件
	       //套装全部附加技能效果，一整套
		set("suit_eff_skill/lianyu-mojing",150+me->query("taozhuang/lv"));
