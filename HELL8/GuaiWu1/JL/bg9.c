...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【四圣限定】"NOR"青龙系列								
"HIG"《套装加成：太始帝经等级+50，攻击力500》"NOR"\n");
	set("value",1000);
	...
	if( me->query("jia/unequip_msg"))
		...
		set("material", "fur");
				 set("suit",HIR"青龙套装"NOR);  //套装名称
		set("suit_lvl",7);	     //套装等级
		set("suit_count",12);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","青龙·护甲");
		set("suit_mod/finger","青龙·戒指");
		set("suit_mod/hands","青龙·手套");
		set("suit_mod/head","青龙·头饰");
		set("suit_mod/neck","青龙·项链");
		set("suit_mod/pants","青龙·护腿");
		set("suit_mod/boots","青龙·护靴");
		set("suit_mod/cloth","青龙·衣服");
		set("suit_mod/surcoat","青龙·披风");
		set("suit_mod/shield","青龙·护盾");
		set("suit_mod/waist","青龙·腰带");
		set("suit_mod/wrists","青龙·护腕");
		...
		set("suit_eff/strength",4);      //9件
	       //套装全部附加技能效果，一整套
		set("suit_eff_skill/yinyangjiuzhuanshierchongtian",50+me->query("taozhuang/lv"));
	setup();
}
