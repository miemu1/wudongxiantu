...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【朱雀限定】"NOR"朱雀系列								
"HIG"《套装加成：阴阳道经等级+150，攻击力500》"NOR"\n");
	set("value",1000);
	...
	if( me->query("jia/unequip_msg"))
		...
		set("material", "fur");
		set("suit",HIR"朱雀套装"NOR);  //套装名称
		set("suit_lvl",7);	     //套装等级
		set("suit_count",12);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","朱雀·护甲");
		set("suit_mod/finger","朱雀·戒指");
		set("suit_mod/hands","朱雀·手套");
		set("suit_mod/head","朱雀·头饰");
		set("suit_mod/neck","朱雀·项链");
		set("suit_mod/pants","朱雀·护腿");
		set("suit_mod/boots","朱雀·护靴");
		set("suit_mod/cloth","朱雀·衣服");
		set("suit_mod/surcoat","朱雀·披风");
		set("suit_mod/shield","朱雀·护盾");
		set("suit_mod/waist","朱雀·腰带");
		set("suit_mod/wrists","朱雀·护腕");
		...
		set("suit_eff/strength",4);      //9件
	       //套装全部附加技能效果，一整套
		set("suit_eff_skill/liangyi-yinyangjue",150+me->query("taozhuang/lv"));
