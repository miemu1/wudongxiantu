...
"HIG"《套装加成：上古秘经等级+999，攻击力9990》"NOR"\n");
	set("value",1000);
	...
	set("armor_type","armor");
		...
		set("suit_eff/constitution",9);      //3件
		set("suit_eff/spirituality",9);      // 5件
		set("suit_eff/intelligence",9);      //7件
		set("suit_eff/strength",9);      //9件
	       //套装全部附加技能效果，一整套
