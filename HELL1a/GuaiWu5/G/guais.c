...
void create()
{
	set_name(HIM"甲壳虫"NOR, ({"jiakechong"}));
	set("nickname", "潜能怪");
	set("gender", "无性");
	set("age", 24);
	set("nolook", 1);
    ...
    set_skill("finger", 100+random(50));
    set_skill("claw", 100+random(50));
    set_skill("blade", 100+random(50));
    set_skill("staff", 100+random(50));
    set_skill("hammer", 100+random(50));
    set_skill("club", 100+random(50));
    set_skill("whip", 100+random(50));
    
    set_skill("shanggu-mijing", 100+random(50));
    set_skill("shanggu-mijing", 100+random(50));
    set_skill("shanggu-mijing", 100+random(50));
    set_skill("shanggu-mijing", 100+random(50));
    set_skill("shanggu-mijing", 100+random(50));
...
//	CHANNEL_D->do_channel(this_object(), "chat", HIR"唉，老身去也！"NOR"");
		...
		me->add("yuanbao",5);
		tell_object(me,sprintf(GRN"你获得了%d点潜能，5灵石！\n"NOR,exp,pot,50000));
