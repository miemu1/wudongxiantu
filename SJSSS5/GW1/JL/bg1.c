...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【出窍限定】"NOR"出窍系列								
"HIG"《套装加成：修仙真法等级+300，攻击力50000》"NOR"\n");
	set("value",1000);
	set("armor_prop/armor", 5000);
	set("armor_prop/leech_qi", 1);
	set("armor_prop/reduce_poison", 1);
	set("armor_prop/reduce_magic", 1);
	set("armor_prop/unarmed_damage", 5000+lv1+lv2+lv3);
	set("armor_prop/damage", 5000+lv1+lv2+lv3);	
	...
	set("armor_type","armor");
		set("material", "armor");
				 set("suit",HIR"出窍套装"NOR);  //套装名称
		set("suit_lvl",6);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","出窍·护甲");
		set("suit_mod/finger","出窍·戒指");
		set("suit_mod/head","出窍·头饰");
		set("suit_mod/neck","出窍·项链");
		set("suit_mod/pants","出窍·护腿");
		set("suit_mod/boots","出窍·护靴");
		set("suit_mod/cloth","出窍·衣服");
		set("suit_mod/waist","出窍·腰带");
		set("suit_mod/wrists","出窍·护腕");
		...
		set("suit_eff/strength",50);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/xiuxian-gongfa",300+me->query("taozhuang/lv"));
	setup();
}
