// ITEM Made by player(ÏÉÈË:fengfeng) /data/item/f/fengfeng-fyf.c
...
void create()
{
	set_name("[41;1m[1;33m½ğµ¤¡¤Ñü´ø[2;37;0m", ({ "fyf" }));
	set_weight(1);
	set("item_make", 1);
	set("unit", "Ìõ");
	set("long", "ÕâÊÇÓÉ[1;37mÁéÊ¯[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»ÌõÑü´ø¡£
");
	set("makeinfo", "[1;31m
ÏÉÈË(fengfeng)[1;31m ×°±¸
[2;37;0m");
