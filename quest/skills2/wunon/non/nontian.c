...
void create()
{
		...
		set("no_put",1);
		set("no_get:",1);
                set("long", "这是一块很好的农田，你可以用("ZJURL("cmds:zhongtian")ZJSIZE(15)""HIY"种田"NOR")来试试你的运气如何。\n");
             }
        setup();
}
...
int do_wakuang()
{
        ...
        {
        me->add("combat_exp",50+random(19));
...
//          this_player()->add("work/wunon",1);
      ...
      if ((int)me->query("work/wunon") > 307200 )
        {
      ...
      if ((int)me->query("work/wunon") > 76800 )
        {
      ...
      if ((int)me->query("work/wunon") > 19200 )
        {
      ...
      if ((int)me->query("work/wunon") > 4800 )
        {
      ...
      if ((int)me->query("work/wunon") > 1600 )
        {
      ...
      if ((int)me->query("work/wunon") > 800 )
        {
