...
void create()
{
		...
		set("no_put",1);
		set("no_get:",1);
                set("long", "这是一块很好的打猎场，你可以用("ZJURL("cmds:bulie")ZJSIZE(15)""HIY"捕猎"NOR")来试试你的运气如何。\n");
             }
        setup();
}
...
//          this_player()->add("work/dalie",1);
      ...
      if ((int)me->query("work/dalie") > 307200 )
        {
      ...
      if ((int)me->query("work/dalie") > 76800 )
        {
      ...
      if ((int)me->query("work/dalie") > 19200 )
        {
      ...
      if ((int)me->query("work/dalie") > 4800 )
        {
      ...
      if ((int)me->query("work/dalie") > 1600 )
        {
      ...
      if ((int)me->query("work/dalie") > 800 )
        {
