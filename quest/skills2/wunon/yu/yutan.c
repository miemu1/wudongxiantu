...
void create()
{
		...
		set("no_put",1);
		set("no_get:",1);
                set("long", "这是一块很好的渔溏，你可以用("ZJURL("cmds:buyu")ZJSIZE(15)""HIY"捕鱼"NOR")来试试你的运气如何。\n");
             }
        setup();
}
...
//          this_player()->add("work/buyu",1);
      ...
      if ((int)me->query("work/buyu") > 307200 )
        {
      ...
      if ((int)me->query("work/buyu") > 76800 )
        {
      ...
      if ((int)me->query("work/buyu") > 19200 )
        {
      ...
      if ((int)me->query("work/buyu") > 4800 )
        {
      ...
      if ((int)me->query("work/buyu") > 1600 )
        {
