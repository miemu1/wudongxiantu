...
int do_eat(string arg)
{
	...
	if ( (int)me->query_condition("a_jiu2" ) > 0 )
	{
		me->add("drunk", 10);
		message_vision(HIR "$N拿起桂花酒就喝了起来,醉意增加了几分！\n" NOR, me);
	}
	else
	{
		...
		me->add("drunk", 10);
		message_vision(HIY "$N喝了口桂花酒，整个人感觉轻飘飘的！\n" NOR, this_player());
		me->apply_condition("a_jiu2", 60);
	}
