...
void create()
{
		...
		set("no_put",1);
		set("no_get:",1);
                set("long", "这是一块很好的造酒场，你可以用("ZJURL("cmds:zhaojiu")ZJSIZE(15)""HIY"造酒"NOR")来试试你的运气如何。\n");
             }
        setup();
}
...
//          this_player()->add("work/zhaojiu",1);
      ...
      if ((int)me->query("work/zhaojiu") > 307200 )
        {
      ...
      if ((int)me->query("work/zhaojiu") > 76800 )
        {
      ...
      if ((int)me->query("work/zhaojiu") > 19200 )
        {
      ...
      if ((int)me->query("work/zhaojiu") > 4800 )
        {
      ...
      if ((int)me->query("work/zhaojiu") > 1600 )
        {
      ...
      if ((int)me->query("work/zhaojiu") > 800 )
        {
