...
void create()
{
  ...
  set_name(names[i]+nm2[random(sizeof(nm2))]+nm3[random(sizeof(nm3))], ({ids[i]}));
	...
	set("class","gumu");
	set("dex", 30);
	set("long", "ËûÊÇÒ»Î»¸ß´óµÄÄÐ×Ó£¬ÏàÃ²¿¡Ðã¡£\n"+
	"ÈÔÈ»ÑÚ²»×¡ËûÃÔÈËµÄ·ç²É¡£\n");
	...
	set_skill("xuantie-sword", 380);
	set_skill("xiantian-qigong", 200);
	set_skill("yunv-shenfa",300);
        set_skill("yunv-jian", 320);     //ÓñÅ®½£
...
if (random(2)==0) map_skill("sword", "yunv-jian");
