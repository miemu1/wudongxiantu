...
"一个身长不足四尺满脸又是伤疤加横肉的小日本。\n");
  ...
  set("max_qi",3000+random(390));
  set("max_jing",3000+random(390));
  set("max_sen",3000+random(390));
  set("max_neili",3000+random(390));
  set("eff_neili",3000+random(390));
  set("neili",3000+random(390));
  set("max_mana",300+random(390));
	...
	set("bellicosity", 10000);
        ...
        set_skill("wind-blade", 10+random(100));
