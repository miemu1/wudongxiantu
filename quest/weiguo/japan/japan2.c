...
"一个身长不足四尺满脸又是伤疤加横肉的小日本。\n");
  ...
  set("max_qi",3000+random(590));
  set("max_jing",3000+random(590));
  set("max_sen",3000+random(590));
  set("max_neili",3000+random(590));
  set("max_mana",3000+random(590));
  set("eff_neili",3000+random(390));
  set("neili",3000+random(590));
        set("per", 1);
        set("age", 22);
        set("shen", -5000);
        set("intellgent",1);
	set("pursuer",1);
        set("combat_exp", 150000+random(300000));
        ...
        set_skill("wind-blade", 50+random(150));
