...
ob->set("max_qi",me->query("max_qi"));
        ...
        ob->set_skill("xue-dao", i*2/3);
        ob->set_skill("unarmed",i*2/3);
        ob->set_skill("xianglong-zhang",i*2/3);
        ob->set_skill("dodge", i*2/3);
        ob->set_skill("blade", i*2/3);
        ob->set_skill("parry", i*2/3);
        ob->set_skill("strike", i*2/3);
        ob->set_skill("dashou-yin", i*2/3);
        ob->set_skill("shenkong-xing", i*2/3);
        ob->set_skill("longxiang", i*2/3);
        ob->set_skill("huntian-qigong", i*2/3);
