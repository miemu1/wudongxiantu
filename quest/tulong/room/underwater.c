...
int do_climb(string arg)
{
   ...
   case 2:
      ...
      room = find_object("/quest/tulong/room/spirit9");
      if(!objectp(room)) room=load_object("/quest/tulong/room/spirit9");
      me->move(room);
...
void do_flush(object me)
{
   ...
   room = find_object("/quest/tulong/room/lake");
   if(!objectp(room)) room= load_object("/quest/tulong/room/lake");
   me->move(room);
