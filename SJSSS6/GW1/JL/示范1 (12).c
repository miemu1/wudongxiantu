// ITEM Made by player(·ç·ç:fengfeng) /data/item/f/fengfeng-bootsa.c
...
void create()
{
	set_name("[1;36m[42mÖñÂíÑ¥[2;37;0m", ({ "bootsa" }));
	set_weight(600);
	set("item_make", 1);
	set("unit", "Ë«");
	set("long", "ÕâÊÇÓÉ[1;35mÎÞÃûÖ®Îï[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»Ë«Ñ¥×Ó¡£
");
	set("makeinfo", "[1;31m
