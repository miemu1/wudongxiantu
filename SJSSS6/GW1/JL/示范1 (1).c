// ITEM Made by player(·ç·ç:fengfeng) /data/item/f/fengfeng-wristsa.c
...
void create()
{
	set_name("[1;36m[42m»ÆÍ©Íó[2;37;0m", ({ "wristsa" }));
	set_weight(500);
	set("item_make", 1);
	set("unit", "¶Ô");
	set("long", "ÕâÊÇÓÉ[1;35mÎÞÃûÖ®Îï[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»¶Ô»¤Íó¡£
");
	set("makeinfo", "[1;31m
