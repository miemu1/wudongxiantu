// ITEM Made by player(·ç·ç:fengfeng) /data/item/f/fengfeng-fingera.c
...
void create()
{
	set_name("[1;36m[44m³¯Â¶Ö¸[2;37;0m", ({ "fingera" }));
	set_weight(350);
	set("item_make", 1);
	set("unit", "Ì×");
	set("long", "ÕâÊÇÓÉ[1;35mÎÞÃûÖ®Îï[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»Ì×Ö¸Ì×¡£
");
	set("makeinfo", "[1;31m
