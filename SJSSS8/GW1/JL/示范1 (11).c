// ITEM Made by player(·ç·ç:fengfeng) /data/item/f/fengfeng-armora.c
...
void create()
{
	set_name("[1;36m[42mÐþ¼×îø[2;37;0m", ({ "armora" }));
	set_weight(1500);
	set("item_make", 1);
	set("unit", "ÕÅ");
	set("long", "ÕâÊÇÓÉ[1;35mÎÞÃûÖ®Îï[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»ÕÅ»¤¼×¡£
");
	set("makeinfo", "[1;31m
