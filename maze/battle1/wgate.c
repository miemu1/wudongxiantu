...
void death_stage(object ob, int stage)
{
        ...
        weishis = (: clonep :)->filter_array(children(__DIR__"npc/weishi.c"));
...
void setup_weishi(object me,object obj)
{
        ...
        me->set_temp("battle/team_name",obj->query_temp("battle/team_name"));
        if( exp>80000000)set("name", "特级武士");
