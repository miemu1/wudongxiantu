...
void create()
{
	...
	set("gender", "男性");
	set("title", HIW "畜生道守护者" NOR);
	set("age", 200);
	set("long", HIC "六道轮回的畜生道。\n\n" NOR);
...
mixed hit_ob(object me, object ob, int damage_bouns)
{
        ...
        damage -= ob->query_temp("apply/reduce_lighting");
        if (damage < 0) damage = 0;
        ob->receive_wound("qi", damage, me);
        me->set("neili", me->query("max_neili"));
        return HIB "$N" HIB "一声暴喝，刹那间霹雳电闪，紫雷"
               HIB "轰鸣，千万道闪电至九天而降，笼罩大地。\n" NOR;
}
...
void ob_die(object me)
{
        ...
        me->set_temp("die_reason", "被畜生道佛给活活杀死了");
        me->die();       
}
...
void lost()
{
        ...
        ob->set("reborn_lunhui", "chushengdao");
        ob->set("special_skill/monster", 1);
