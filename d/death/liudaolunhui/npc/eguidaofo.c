...
void create()
{
	set_name(HIC "饿鬼道佛" NOR, ({ "eguidao fo", "eguidao", "fo" }) );
	set("gender", "男性");
	set("title", HIW "饿鬼道守护者" NOR);
	set("age", 200);
	set("long", HIC "六道轮回的饿鬼道。\n\n" NOR);
...
mixed hit_ob(object me, object ob, int damage_bouns)
{
        ...
        return HIB "$N" HIB "一声暴喝，身后登时腾起无数冤魂，一齐恸哭哀嚎。\n" NOR;
}
...
void ob_die(object me)
{
        ...
        me->set_temp("die_reason", "被饿鬼道佛给活活杀死了");
        me->die();       
}
...
void lost()
{
        ...
        ob->set("reborn_lunhui", "eguidao");
        ob->set("special_skill/nopoison", 1);
