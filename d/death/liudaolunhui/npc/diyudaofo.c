...
void create()
{
	set_name(HIC "地狱道佛" NOR, ({ "diyudao fo", "diyudao", "fo" }) );
	set("gender", "男性");
	set("title", HIW "地狱道守护者" NOR);
	set("age", 200);
	set("long", HIC "六道轮回的地狱道。\n\n" NOR);
...
void ob_die(object me)
{
        ...
        me->set_temp("die_reason", "被地狱道佛给活活杀死了");
        me->die();       
}
...
void lost()
{
        ...
        ob->set("reborn_lunhui", "diyudao");
        ob->set("special_skill/ghost", 1);
