...
void create()
{
	set_name(HIC "修罗道佛" NOR, ({ "xiuluodao fo", "xiuluodao", "fo" }) );
	set("gender", "男性");
	set("title", HIW "修罗道守护者" NOR);
	set("age", 200);
	set("long", HIC "六道轮回的修罗道。\n\n" NOR);
...
mixed hit_ob(object me, object ob, int damage_bouns)
{
        ...
        return HIB "$N" HIB "一声暴喝，地面扬起一片火海，似"
               HIB "乎整个大地都要被烤焦了一般。\n" NOR;
}
...
void ob_die(object me)
{
        ...
        me->set_temp("die_reason", "被修罗道佛给活活杀死了");
        me->die();       
}
...
void lost()
{
        ...
        ob->set("reborn_lunhui", "xiuluodao");
        ob->set("special_skill/demon", 1);
