...
int do_pull(string arg)
{
	...
	if( sscanf(arg, "stone %s", dir)==1 && (int)query("poem_said")>=1 ) {
		if( dir=="up" ) {
			message_vision("$N将石碑"ZJURL("cmds:pull stone up")"往上抬"NOR"...，忽然「喀」一声石碑又移回原位。\n",
				this_player());
			add("up_trigger", 1);
			check_trigger();
			return 1;
...
int do_push(string arg)
{
	...
	if( sscanf(arg, "stone %s", dir)==1 && (int)query("poem_said")>=1 ) {
		if( dir=="down" ) {
			message_vision("$N将石碑"ZJURL("cmds:push stone down")"往下压"NOR"...，忽然「喀」一声石碑又移回原位。\n",
				this_player());
			add("down_trigger", 1);
			check_trigger();
			return 1;
...
int do_say(string arg)
{
	...
	if( arg=="上报四重恩，下济三途苦" ||arg=="上报四重恩 下济三途苦" ||arg=="上报四重恩,下济三途苦" ) {
...
string look_tower()
{
	...
	"    ※※※※　一切世界佛，悉发菩提心，　※※※※\n"
	"    ※※※※　　　　　　　　　　　　　　※※※※\n"
	"    ※※※※　"ZJURL("cmds:say 上报四重恩，下济三途苦")"上报四重恩，下济三途苦"NOR"，　※※※※\n"
	"    ※※※※　　　　　　　　　　　　　　※※※※\n"
	"    ※※※※　无边大法力，渡劫升极乐，　※※※※\n"
	"    ※※※※　　　　　　　　　　　　　　※※※※\n"
	"    ※※※※　愿以此功德，庄严佛净土。　※※※※\n"
...
string look_stone()
{
	...
	"    ※※※※※※※※※※※※※※※※※※※※※※\n"
	"    ※※※※※※※※※※※※※※※※※※※※※※\n"
"    好像可以"ZJURL("cmds:pull stone up")"向上抬"NOR"或者"ZJURL("cmds:push stone down")"向下压"NOR"。\n";
}
