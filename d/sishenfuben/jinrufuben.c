...
if (me->query("tiaozhancishu")>1 )
return notify_fail("你今天已经挑战过了。\n");//超过次数提示

if (objectp(competitionroom= new("/d/sishenfuben/fangjian"))&&objectp(npc=new("/d/sishenfuben/npc/npcshuxing")))//读取地图 读取npc位置
