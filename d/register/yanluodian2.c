...
LONG );
	...
	set("item_desc", ([
		...
		"洗点" : "投胎前选择你想发展的路线。\n"
				ZJOBACTS2+ZJMENUF(2,2,8,30)"臂力流(降龙十八掌):washto 30 13 24 13"ZJSEP"悟性流(独孤九剑):washto 13 30 24 13"ZJSEP"根骨流(黯然销魂掌):washto 13 24 30 13"ZJSEP"身法流(辟邪剑法，葵花神功):washto 13 13 24 30"ZJSEP"\n",
	]));
