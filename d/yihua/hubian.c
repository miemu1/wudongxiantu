...
void create()
{
        set("short", "湖边");
        set("long", @LONG
这个就是谷底的大湖，湖水一平入镜，月光映入湖中，湖心也是
一轮皎洁的圆月。湖畔还生着一丛丛的各式各样的茶花。在月光下摇
曳生姿。此湖呈椭圆形状，大部分隐入了花树丛中。东南西北全是岩
石(stone) 和悬崖，(xuanya) 但是悬崖十分陡峭，即使是绝顶的高手，
也无法攀缘而上。
LONG );
