...
string ask_job()
{
	...
	tell_object(me,ZJEXIT"northwest:"RED"中断缝纫"NOR":halt\n");
	return "好，你就帮我做点"ZJURL("cmds:sew")ZJSIZE(15)"裁缝"NOR"(sew)的小活吧！喏，东西都在这儿。";
}
