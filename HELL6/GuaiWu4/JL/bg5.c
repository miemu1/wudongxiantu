...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【四凶限定】"NOR"梼杌系列								
"HIG"《套装加成：太元帝经等级+155，攻击力550》"NOR"\n");
	set("value",1000);
	...
	if( me->query("jia/unequip_msg"))
		...
		set("material", "fur");
		set("suit",HIR"梼杌套装"NOR);  //套装名称
		set("suit_lvl",7);	     //套装等级
		set("suit_count",12);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","梼杌·护甲");
		set("suit_mod/finger","梼杌·戒指");
		set("suit_mod/hands","梼杌·手套");
		set("suit_mod/head","梼杌·头饰");
		set("suit_mod/neck","梼杌·项链");
		set("suit_mod/pants","梼杌·护腿");
		set("suit_mod/boots","梼杌·护靴");
		set("suit_mod/cloth","梼杌·衣服");
		set("suit_mod/surcoat","梼杌·披风");
		set("suit_mod/shield","梼杌·护盾");
		set("suit_mod/waist","梼杌·腰带");
		set("suit_mod/wrists","梼杌·护腕");
		...
		set("suit_eff/strength",5);      //9件
	       //套装全部附加技能效果，一整套
		set("suit_eff_skill/wanmo-futi",155+me->query("taozhuang/lv"));
