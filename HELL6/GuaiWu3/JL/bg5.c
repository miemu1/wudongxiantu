...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【饕餮限定】"NOR"饕餮系列								
"HIG"《套装加成：龙王圣经等级+155，攻击力550》"NOR"\n");
	set("value",1000);
	...
	if( me->query("jia/unequip_msg"))
		...
		set("material", "fur");
		set("suit",HIR"饕餮套装"NOR);  //套装名称
		set("suit_lvl",7);	     //套装等级
		set("suit_count",12);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","饕餮·护甲");
		set("suit_mod/finger","饕餮·戒指");
		set("suit_mod/hands","饕餮·手套");
		set("suit_mod/head","饕餮·头饰");
		set("suit_mod/neck","饕餮·项链");
		set("suit_mod/pants","饕餮·护腿");
		set("suit_mod/boots","饕餮·护靴");
		set("suit_mod/cloth","饕餮·衣服");
		set("suit_mod/surcoat","饕餮·披风");
		set("suit_mod/shield","饕餮·护盾");
		set("suit_mod/waist","饕餮·腰带");
		set("suit_mod/wrists","饕餮·护腕");
		...
		set("suit_eff/strength",5);      //9件
	       //套装全部附加技能效果，一整套
		set("suit_eff_skill/longwang-shengjing",155+me->query("taozhuang/lv"));
