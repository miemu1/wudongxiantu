...
void init()
{
	...
	add_action("do_qiongqii","qiongqiijia");
...
//读入数据
	...
	lv3=(me->query("jinjie/s2"));		
        ...
        {
	w_name=HIC "穷奇·手套" NOR;
        }
        if (!me->query("jiajia/id"))
        {
	w_id="shouss qiongqi5";
        }
	...
	set("unit", "件");
		set("long", HIC"【穷奇限定】"NOR"穷奇系列								
"HIG"《套装加成：斗战圣经等级+155，攻击力550》"NOR"\n");
	set("value",1000);
	...
	if( me->query("jia/unequip_msg"))
		...
		set("material", "fur");
		set("suit",HIR"穷奇套装"NOR);  //套装名称
		set("suit_lvl",7);	     //套装等级
		set("suit_count",12);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","穷奇·护甲");
		set("suit_mod/finger","穷奇·戒指");
		set("suit_mod/hands","穷奇·手套");
		set("suit_mod/head","穷奇·头饰");
		set("suit_mod/neck","穷奇·项链");
		set("suit_mod/pants","穷奇·护腿");
		set("suit_mod/boots","穷奇·护靴");
		set("suit_mod/cloth","穷奇·衣服");
		set("suit_mod/surcoat","穷奇·披风");
		set("suit_mod/shield","穷奇·护盾");
		set("suit_mod/waist","穷奇·腰带");
		set("suit_mod/wrists","穷奇·护腕");
	    //套装全部附加天赋效果  //身法第一，根骨第二，悟性第三，臂力第四
		set("suit_eff/constitution",5);      //3件
		set("suit_eff/spirituality",5);      // 5件
		set("suit_eff/intelligence",5);      //7件
		set("suit_eff/strength",5);      //9件
	       //套装全部附加技能效果，一整套
		set("suit_eff_skill/douzhan-shengjing",155+me->query("taozqiongqiang/lv"));
