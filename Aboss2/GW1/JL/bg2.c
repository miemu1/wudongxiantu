...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【混沌限定】"NOR"混沌系列								
"HIG"《套装加成：苍炎仙法等级+1000》"NOR"\n");
	set("value",1000);
	...
	set("armor_type","boots");
		...
		set("suit_eff/strength",random(20)+40);      //9件
	       //套装全部附加技能效果，一整套
		set("suit_eff/constitution",999);      //3件
		set("suit_eff/spirituality",999);      // 5件
		set("suit_eff/intelligence",999);      //7件
		set("suit_eff/strength",999);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/cangyan-xianfa",1000+me->query("taozhuang/lv"));
	setup();
}
